...
using DiscoverSlopesWebApiAuth.Models;
using DiscoverSlopesWebApiAuth.ViewModels;
...
namespace DiscoverSlopesWebApiAuth.Controllers
{
  ...
  public class ExternalAuthController : Controller
  {
    ...
    public ExternalAuthController(IOptions<FacebookAuthSettings> fbAuthSettingsAccessor, UserManager<DiscoverSlopes.Models.ApplicationUser> userManager, ApplicationDbContext appDbContext, IJwtFactory jwtFactory, IOptions<JwtIssuerOptions> jwtOptions)
    {
    ...
    public async Task<IActionResult> Facebook([FromBody]FacebookAuthViewModel model)
    {
      ...
      if (user == null)
      {
        var appUser = new DiscoverSlopes.Models.ApplicationUser
		{
